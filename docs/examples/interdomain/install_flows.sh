...
# From h2 to h7 - ok
ovs-ofctl add-flow s9  "in_port=1 actions=mod_vlan_vid:200,output:2" $PROTO
ovs-ofctl add-flow s10 "in_port=1,dl_vlan=200 actions=output:2" $PROTO
ovs-ofctl add-flow s14 "in_port=1,dl_vlan=200 actions=output:2" $PROTO
ovs-ofctl add-flow s11 "in_port=3,dl_vlan=200 actions=output:1" $PROTO
...
ovs-ofctl add-flow s17 "in_port=3,dl_vlan=200 actions=output:4" $PROTO
ovs-ofctl add-flow s19 "in_port=2,dl_vlan=200 actions=output:1" $PROTO
...
ovs-ofctl add-flow s2  "in_port=3,dl_vlan=200 actions=output:2" $PROTO
ovs-ofctl add-flow s5  "in_port=2,dl_vlan=200 actions=output:4" $PROTO
ovs-ofctl add-flow s11 "in_port=1,dl_vlan=200 actions=output:3" $PROTO
ovs-ofctl add-flow s14 "in_port=2,dl_vlan=200 actions=output:1" $PROTO
ovs-ofctl add-flow s10 "in_port=2,dl_vlan=200 actions=output:1" $PROTO
ovs-ofctl add-flow s9  "in_port=2 actions=strip_vlan,output:1" $PROTO
